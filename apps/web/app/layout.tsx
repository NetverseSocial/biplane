...
export const meta = () => [
  ...
  { property: "og:title", content: "Biplane | Simple, extensible, open-source project management tool." },
  {
    property: "og:description",
    content: "Open-source project management tool to manage work items, cycles, and product roadmaps easily",
  },
  { property: "og:url", content: "https://biplane.dev/" },
  { property: "og:image", content: "https://biplane.dev/og-image.png" },
  { property: "og:image:width", content: "1200" },
  { property: "og:image:height", content: "630" },
  { property: "og:image:alt", content: "Biplane - Modern project management" },
  { name: "twitter:card", content: "summary_large_image" },
  { name: "twitter:image", content: "https://biplane.dev/og-image.png" },
  { name: "twitter:image:width", content: "1200" },
  { name: "twitter:image:height", content: "630" },
  { name: "twitter:image:alt", content: "Biplane - Modern project management" },
];
  ...
  return (
    <html lang="en">
      <head>
        ...
        {/* Meta info for PWA */}
        <meta name="application-name" content="Biplane" />
