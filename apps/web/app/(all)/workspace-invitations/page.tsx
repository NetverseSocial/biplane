        ...
        {invitationDetail && !invitationDetail.responded_at ? (
          error ? (
            ...
            <EmptySpace
              ...
              description="Your workspace is where you'll create projects, collaborate on your work items, and organize different streams of work in your Biplane account."
            >
          ...
          invitationDetail?.accepted ? (
            ...
            >
              ...
              <EmptySpaceItem Icon={Star} title="Star us on GitHub" href="https://github.com/NetverseSocial/biplane" />
              <EmptySpaceItem
                Icon={Share2}
