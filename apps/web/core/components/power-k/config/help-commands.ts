...
export const usePowerKHelpCommands = (): TPowerKCommandConfig[] => {
  ...
  return [
    ...
    },
    {
      ...
      icon: FileText,
      action: () => {
        window.open("https://github.com/NetverseSocial/biplane#readme", "_blank", "noopener,noreferrer");
      },
      isEnabled: () => true,
      isVisible: () => true,
      closeOnSelect: true,
    },
    {
      ...
      icon: MessageSquare,
      action: () => {
        window.open("https://github.com/NetverseSocial/biplane/discussions", "_blank", "noopener,noreferrer");
      },
      isEnabled: () => true,
      isVisible: () => true,
      closeOnSelect: true,
    },
    {
      ...
      icon: GithubIcon,
      action: () => {
        window.open("https://github.com/NetverseSocial/biplane/issues/new/choose", "_blank", "noopener,noreferrer");
      },
      isEnabled: () => true,
      isVisible: () => true,
      closeOnSelect: true,
