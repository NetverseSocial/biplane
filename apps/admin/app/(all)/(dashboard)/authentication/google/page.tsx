    ...
    <PageWrapper
      customHeader={
        <AuthenticationMethodCard
          name="Google"
          description="Allow members to login or sign up to Biplane with their Google
            accounts."
...
export const meta: Route.MetaFunction = () => [{ title: "Google Authentication - Biplane Admin" }];
