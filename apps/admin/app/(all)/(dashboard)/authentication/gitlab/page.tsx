    ...
    <PageWrapper
      customHeader={
        <AuthenticationMethodCard
          name="GitLab"
          description="Allow members to login or sign up to Biplane with their GitLab accounts."
...
export const meta: Route.MetaFunction = () => [{ title: "GitLab Authentication - Biplane Admin" }];
