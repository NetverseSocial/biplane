...
const helpOptions = [
  {
    name: "Documentation",
    href: "https://github.com/NetverseSocial/biplane#readme",
    Icon: PageIcon,
  },
  {
    name: "Join our Forum",
    href: "https://github.com/NetverseSocial/biplane/discussions",
    Icon: MessageSquare,
  },
  {
    name: "Report a bug",
    href: "https://github.com/NetverseSocial/biplane/issues/new/choose",
    Icon: GithubIcon,
  },
];
  ...
  return (
    ...
    >
      <div className={`flex items-center gap-1 ${isSidebarCollapsed ? "flex-col justify-center" : "w-full"}`}>
        <Tooltip tooltipContent="Redirect to Biplane" position="right" className="ml-4" disabled={!isSidebarCollapsed}>
          <a
          ...
          >
            ...
            {!isSidebarCollapsed && "Redirect to Biplane"}
          </a>
        </Tooltip>
