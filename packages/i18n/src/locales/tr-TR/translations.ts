...
export default {
  ...
  auth: {
    common: {
      ...
      new_to_plane: "Biplane'e yeni mi geldiniz?",
  ...
  support: "Destek",
  forum: "Forum",
  powered_by_plane_pages: "Biplane Pages tarafından desteklenmektedir",
  ...
  home: {
    empty: {
      ...
      create_project: {
        title: "Proje oluştur",
        description: "Çoğu şey Biplane'de bir projeyle başlar.",
        cta: "Başla",
      },
      invite_team: {
      ...
      personalize_account: {
        title: "Biplane'yi kendinize özelleştirin.",
  ...
  workspace_creation: {
    ...
    subheading: "Biplane'i kullanmaya başlamak için bir çalışma alanı oluşturmalı veya katılmalısınız.",
    form: {
      name: {
  ...
  workspace_dashboard: {
    empty_state: {
      general: {
        ...
        description:
          "Biplane'e hoş geldiniz, sizi aramızda görmekten heyecan duyuyoruz. İlk projenizi oluşturun ve iş öğelerinizi takip edin, bu sayfa ilerlemenize yardımcı olacak bir alana dönüşecek. Yöneticiler ayrıca ekiplerinin ilerlemesine yardımcı olacak öğeler görecek.",
        primary_button: {
          text: "İlk projenizi oluşturun",
          comic: {
            title: "Biplane'de her şey bir projeyle başlar",
            description:
  ...
  workspace_settings: {
    ...
    copy_key:
      "Bu gizli anahtarı Biplane Pages'e kopyalayıp kaydedin. Kapat düğmesine bastıktan sonra bu anahtarı göremezsiniz. Anahtar içeren bir CSV dosyası indirildi.",
    ...
    settings: {
      ...
      api_tokens: {
        ...
        delete: {
          ...
          description: "Bu token'ı kullanan uygulamalar artık Biplane verilerine erişemeyecek. Bu işlem geri alınamaz.",
          success: {
            title: "Başarılı!",
    ...
    empty_state: {
      api_tokens: {
        ...
        description: "Biplane API'lerini harici sistemlere entegre etmek için bir token oluşturun.",
      },
      webhooks: {
  ...
  profile: {
    ...
    empty_state: {
      activity: {
        ...
        description:
          "Yeni bir iş öğesi oluşturarak başlayın! Detaylar ve özellikler ekleyin. Aktivitenizi görmek için Biplane'de daha fazlasını keşfedin.",
      },
      assigned: {
  ...
  project_settings: {
    ...
    automations: {
      ...
      "auto-archive": {
        ...
        description: "Biplane, tamamlanan veya iptal edilen iş öğelerini otomatik arşivleyecek.",
        duration: "Şu süre kapalı kalan iş öğelerini otomatik arşivle",
      },
      "auto-close": {
        title: "İş öğelerini otomatik kapat",
        description: "Biplane, tamamlanmamış veya iptal edilmemiş iş öğelerini otomatik kapatacak.",
    ...
    empty_state: {
      no_issues: {
        ...
        primary_button: {
          ...
          comic: {
            title: "İş öğeleri Biplane'de yapı taşlarıdır.",
            description:
              "Biplane UI'yi yeniden tasarlamak, şirketi yeniden markalaştırmak veya yeni yakıt enjeksiyon sistemini başlatmak, muhtemelen alt iş öğeleri olan iş öğesi örnekleridir.",
          },
        },
      },
      no_archived_issues: {
  ...
  project_page: {
    empty_state: {
      general: {
        title:
          "Bir not, belge veya tam bir bilgi bankası yazın. Biplane'in AI asistanı Galileo'nun başlamanıza yardımcı olmasını sağlayın",
        description:
          "Sayfalar Biplane'de düşüncelerinizi döktüğünüz alanlardır. Toplantı notları alın, kolayca biçimlendirin, iş öğelerini yerleştirin, bir bileşen kitaplığı kullanarak düzenleyin ve hepsini proje bağlamınızda tutun. Herhangi bir belgeyi hızlıca tamamlamak için bir kısayol veya düğme ile Biplane'in AI'sı Galileo'yu çağırın.",
        primary_button: {
  ...
  self_hosted_maintenance_message: {
    plane_didnt_start_up_this_could_be_because_one_or_more_plane_services_failed_to_start:
      "Biplane başlatılamadı. Bu, bir veya daha fazla Biplane servisinin başlatılamaması nedeniyle olabilir.",
