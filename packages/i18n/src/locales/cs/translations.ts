...
export default {
  ...
  support: "Podpora",
  forum: "Forum",
  powered_by_plane_pages: "Poháněno Biplane Pages",
  ...
  home: {
    empty: {
      ...
      create_project: {
        ...
        description: "Většina věcí začíná projektem v Biplane.",
        cta: "Začít",
      },
      invite_team: {
        title: "Pozvat tým",
  ...
  workspace_creation: {
    ...
    subheading: "Pro používání Biplane musíte vytvořit nebo se připojit k pracovnímu prostoru.",
    form: {
      name: {
  ...
  workspace_dashboard: {
    empty_state: {
      general: {
        ...
        description:
          "Vítejte v Biplane, jsme rádi, že jste zde. Vytvořte první projekt, sledujte pracovní položky a tato stránka se promění v prostor pro váš pokrok. Správci zde uvidí i položky pomáhající týmu.",
        primary_button: {
          text: "Vytvořte první projekt",
          comic: {
            title: "Vše začíná projektem v Biplane",
  ...
  workspace_settings: {
    ...
    copy_key:
      "Zkopírujte a uložte tento klíč do Biplane Pages. Po zavření jej neuvidíte. CSV soubor s klíčem byl stažen.",
    ...
    empty_state: {
      api_tokens: {
        ...
        description: "Používejte API pro integraci Biplane s externími systémy.",
      },
      webhooks: {
  ...
  project_settings: {
    ...
    automations: {
      ...
      "auto-archive": {
        ...
        description: "Biplane bude automaticky archivovat pracovní položky, které byly dokončeny nebo zrušeny.",
        duration: "Automaticky archivovat pracovní položky, které jsou uzavřené po dobu",
      },
      "auto-close": {
        title: "Automaticky uzavírat pracovní položky",
        description: "Biplane automaticky uzavře pracovní položky, které nebyly dokončeny nebo zrušeny.",
  ...
  self_hosted_maintenance_message: {
    plane_didnt_start_up_this_could_be_because_one_or_more_plane_services_failed_to_start:
      "Biplane se nespustil. To může být způsobeno tím, že se jeden nebo více služeb Biplane nepodařilo spustit.",
